...
app.get('/asset/:token_id\.:ext?', async function(req, res) {
    const tokenId = parseInt(req.params.token_id).toString();
    const tokenUri = await ct.getTokenUri(tokenId);
    res.send(tokenUri);
})


//GENERATE METADATA FROM TOKENID AND INSERT INTO DB
app.post('/asset/:data', async function(req, res) {
...
app.post('/asset/change/:data', async function(req, res) {
    const data = req.params.data;
...
app.get('/asset/attributes/:name', async function(req, res) {
...
//RETIREVE RARITIES
app.get('/rarities', async function(req, res) {
...
//RETRIEVE TIPOLOGIES
app.get('/tipologies', async function(req, res) {
...
app.get('/lands', async function(req, res) {
...
//RETRIEVE STRUCTURE
app.get('/lands_parcel', async function(req, res) {
...
app.get('/apartment_size', async function(req, res) {
